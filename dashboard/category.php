			     ...
			     <div class="row">
				    <div class="col-md-12">
					   ...
					   <table class="table table-striped table-hover">
						  ...
						  <tbody>
						  <?php $query=mysqli_query($con,"select * from category limit $page1,5");
						  $num=mysqli_num_rows($query);
...
<?php if ($role==3) {
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="add_category" class="btn btn-success">Add</button>
				   ...
				   <?php
					...
					$query=mysqli_query($con,"SELECT  `name` FROM `category` WHERE `id`=$id");
					while ($row=mysqli_fetch_assoc($query)) {
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		<form action="category_crud.php?id=<?php echo $id; ?>" method="post" >
        <div class="form-group">
		    <label>Name</label>
			<input type="text" name="category_name" value="<?php echo $row['name'];?>" class="form-control" required>
		</div>
						...
						<div class="modal fade" tabindex="-1" id="delete" role="dialog">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
										<a href="category_crud.php?no=<?php echo $id; ?>" class="btn btn-success">delete</a>
									</div>
								</div>
							</div>
						</div>
