                        ...
                        <div class="table-wrapper">
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    $query = mysqli_query($con, "select * from user_list where username='$filter' limit $page1,5");
                                    $num=mysqli_num_rows($query);
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <th> <a href="?update-image=<?php echo $row['id']; ?>"><img src="<?php echo 'data:image/png;base64 ,' . base64_encode($row['image']) ?> " alt="" style="height: 50px; width: 60px;"></a></th>

                                            <th><?php echo $row['role_name']; ?></th>
                                            <?php if ($row['status'] == 1&&$role==3) {
                                                echo '<th><a href="user_crud.php?status_no=' . $row['id'] . '&status=0 "   style=" background-color: yellow; ">unactive</a></th>';
                                            } elseif ($row['status'] == 0) {
                                                echo '<th><a href="user_crud.php?status_no=' . $row['id'] . '&status=1"  style=" background-color: rgb(23, 149, 199); ">active</a></th>';
                                            } else {
