				...
				<div class="row">
					<div class="col-md-12">
						<div class="table-wrapper">
							...
							<table class="table table-striped table-hover">
								...
								<tbody>
								<?php $query=mysqli_query($con,"select * from jobseeker_view limit $page1,5");
								$num=mysqli_num_rows($query);
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title">Add Jobseeker</h5>
								...
								<div class="modal-body">
									...
									<div class="form-group">
										...
										$query=mysqli_query($con,"select id , username from user_list where role_name='jobseeker' ");
										while($row=mysqli_fetch_assoc($query)){
										?>
					...
					<div class="modal fade" tabindex="-1" id="edit" role="dialog">
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title">Edit Jobseeker</h5>
									<button type="button" class="close" data-dismiss="modal" aria-label="Close">
										<span aria-hidden="true">&times;</span>
									</button>
								</div>
