...
<body>
						...
						<div class="table-wrapper">
							...
							<table class="table table-striped table-hover">
								...
								<tbody>
                                    ...
                                    $query=mysqli_query($con,"select * from company_view where co_name='$filter' limit $page1,5");
									$num=mysqli_num_rows($query);
									...
									<tr>
										...
										<th   >
											...
											<?php if ($row['status'] == 1) {
												...
												<i class="material-icons" data-toggle="tooltip" title="edit user privileges">rule customize</i></a>
												</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		<form action="company_crud.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" >
        <div class="form-group">
