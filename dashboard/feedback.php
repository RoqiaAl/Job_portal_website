			     ...
			     <div class="row">
				    <div class="col-md-12">
					   ...
					   <div class="table-title">
					     <div class="row">
						     <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
							    <h2 class="ml-lg-2">Manage feedbacks</h2>
							 </div>
					   ...
					   <table class="table table-striped table-hover">
						  ...
						  <tbody>
						  <?php $query = mysqli_query($con, "select * from feedback limit $page1,5");
						  $num=mysqli_num_rows($query);
							 ...
							 <th class="review"><?php echo $row['body']; ?></th>
							 <th class="review"><?php echo $row['replay']; ?></th>
				   ...
				   $query=mysqli_query($con,"SELECT  `replay` FROM `feedback` WHERE `id`=$id");
				   while ($row=mysqli_fetch_assoc($query)) {
 ...
 <div class="modal-dialog" role="document">
   <div class="modal-content">
	 ...
	 <div class="modal-body">
	   <form action="feedback_crud.php?id=<?php echo $id; ?>" method="post" >
	   <div class="form-group">
		   <label>Name</label>
		   <input type="text" name="replay" value="<?php echo $row['replay'];?>" class="form-control" required>
	   </div>
	   
	 </div>
	 <div class="modal-footer">
	   <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
	   <button type="submit" name="update_replay" class="btn btn-success">update</button>
	 </div>
	 </form>
   </div>
 </div>
