...
<body>
    ...
    <div class="wrapper">
					...
					<div class="col-md-12">
						<div class="table-wrapper">
							...
							<table class="table table-striped table-hover">
								...
								<tbody>
									<?php $query = mysqli_query($con, "select * from role limit $page1,5 ");
																						$num=mysqli_num_rows($query);
									...
									?>
										<tr>
											...
											<th> <a href="view_privileges.php?id=<?php echo $row['role_id']; ?>" class="edit" >customize</a>
					...
					<div class="modal fade" tabindex="-1" id="addEmployeeModal" role="dialog">
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								...
								<form action="role_crud.php" method="post" >
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="add_role" class="btn btn-success">Add</button>
      </div>
	  </form>
							</div>
						</div>
