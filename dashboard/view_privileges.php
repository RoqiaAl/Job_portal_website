...
<body>
    <section id="companies" class="text-center">
        ...
        <div class="container">
            ...
            <form action="role_crud.php?id=<?php echo $_GET['id'];?>" method="post">
                ...
                <div class="row g-4 text-start">
                    ...
                    $update= mysqli_query($con, "select * from role_privilege where role_id=$id ");
                    ...
                    ?>
                            ...
                            <div class="col-md-4 class " data-aos="fade-up">
                                <h4>manage role_privilege</h4>
                                <?php
                                require "../connection.php";
                                $query = mysqli_query($con, "select * from privileges where class_id=10 ");
                                if (mysqli_num_rows($query) > 0) {
                                    foreach ($query as $privilege) {
                                ?>
                                         <input type="checkbox" name="privilege[]" <?php echo in_array($privilege['privilege_id'], $selected_privilege) ? 'checked':''; ?> 
                            ...
                            <div class="col-md-4 class " data-aos="fade-up">
                                ...
                                <?php
                                require "../connection.php";
                                $query = mysqli_query($con, "select * from privileges where class_id=8 ");
                                if (mysqli_num_rows($query) > 0) {
                                    foreach ($query as $privilege) {
                                ?>
                                          <input type="checkbox" name="privilege[]" <?php echo in_array($privilege['privilege_id'], $selected_privilege) ? 'checked':''; ?> 
                            ...
                            <div class="col-md-4 class " data-aos="fade-up">
                                ...
                                <?php
                                require "../connection.php";
                                $query = mysqli_query($con, "select * from privileges where class_id=5 ");
                                if (mysqli_num_rows($query) > 0) {
                                    foreach ($query as $privilege) {
                                ?>
                                         <input type="checkbox" name="privilege[]" <?php echo in_array($privilege['privilege_id'], $selected_privilege) ? 'checked':''; ?> 
                            ...
                            <div class="col-md-4 class " data-aos="fade-up">
                                ...
                                <?php
                                require "../connection.php";
                                $query = mysqli_query($con, "select * from privileges where class_id=4 ");
                                if (mysqli_num_rows($query) > 0) {
                                    foreach ($query as $privilege) {
                                ?>
                                         <input type="checkbox" name="privilege[]" <?php echo in_array($privilege['privilege_id'], $selected_privilege) ? 'checked':''; ?> 
                            ...
                            <div class="col-md-4 class " data-aos="fade-up">
                                ...
                                <?php
                                require "../connection.php";
                                $query = mysqli_query($con, "select * from privileges where class_id=7 ");
                                if (mysqli_num_rows($query) > 0) {
                                    foreach ($query as $privilege) {
                                ?>
                                         <input type="checkbox" name="privilege[]" <?php echo in_array($privilege['privilege_id'], $selected_privilege) ? 'checked':''; ?> 
                ...
                <div class="buttons">
                    <div class="form-groub mt-3">
                        <button type="submit" name="add_privilege" class="btn btn-primary">insert</button>

                    </div>
                    <div class="form-groub mt-3">
                        <button type="submit" name="update_privilege" class="btn btn-primary">update</button>
