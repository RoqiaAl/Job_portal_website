...
<body>
    <?php
    if (isset($_GET['sk_edit'])) {

        $no = $_GET['sk_edit'];
        $sql = mysqli_query($con, "call get_by_clause('skill','id','$no');");
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">تعديل المهارة</h4>
                        <button type="button" class="close" onclick="goBack()" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="../server/jobseeker/update_skill.php?no=<?php echo $row['id']; ?>" method="POST" autocomplete="off" enctype="multipart/form-data">
                            <div class="row gap-20 modalbody">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="أدخل اسم المهارة" type="text" name="title" required value="<?php echo $row['title']; ?>">
                                    </div>
                            ...
                            <div class="modal-footer text-center">
                                <button type="submit" class="btn btn-primary" name="update_skill">حفظ</button>
                ...
                <div class="container-xxl py-5">
                    <div>
                        ...
                        <div class="row g-4 text-start">
                            ...
                            <?php
                            require "../connection.php";
                            $result2 = mysqli_query($con, "call get_by_clause('skill','s_id','$id');");

                            while ($row = mysqli_fetch_assoc($result2)) {

                            ?>
                                <div class="col-md-6">
                                    <div id="tab-1" class="tab-pane fade show p-0 active skills">
                                                ...
                                                <div class="col-sm-12 col-md-6 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="resume-list-btn">
                                                            <a href="?sk_edit=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm mb-0-sm">تعديل</a>
                                                            <a onclick="return confirm('هل انت متاكد انك تريد الحذف ؟')" class="btn btn-primary btn-sm mb-0-sm btn-delete" href="../server/jobseeker/delete_skill.php?no=<?php echo $row['id']; ?>">حذف</a>
                        ...
                        <div>
                            ...
                            <div class="modal" id="QualifModal">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">إضافة مهارة</h4>
                                            <button type="button" class="close" data-bs-dismiss="modal" aria-hidden="true">&times;</button>
                                        </div>
                                        <div class="modal-body">
                                            <form action="../server/jobseeker/add_skill.php" method="POST" autocomplete="off" enctype="multipart/form-data">
                                                <div class="row gap-20 modalbody">
                                                    ...
                                                    <div class="col-sm-12 col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            <label>اسم المهارة</label>
                                                            <input class="form-control" placeholder="أدخل اسم المهارة" type="text" name="title" required>
                                                        </div>
                                                ...
                                                <div class="modal-footer text-center">
                                                    <button type="submit" class="btn btn-primary" name="add_skill">حفظ</button>
                                                    <button type="button" data-bs-dismiss="modal" onclick="goBack()" class="btn btn-primary">إلغاء</button>
                                                </div>
                                            </form>
