...
<?php
	...
	if(isset($_GET['q_edit'])){
		...
		$no = $_GET['q_edit'];
					$sql = mysqli_query($con , " call get_by_clause('qualification','id','$no'); ");
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">تعديل المؤهل العلمي</h4>
                <button type="button" class="close" onclick="goBack()" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="../server/jobseeker/update_qualification.php?no=<?php echo $row['id']; ?>" method="POST" autocomplete="off" enctype="multipart/form-data">
                    <div class="row gap-20 modalbody">
                        ...
                        <div class="col-sm-6 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="أدخل اسم التخصص" type="text" name="title" required value="<?php echo $row['title']; ?>">
                            </div>
                        ...
                        <div class="col-sm-6 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="educational_level" required class=" form-group selectpicker show-tick form-control" data-live-search="false" data-selected-text-format="count > 3" data-done-button="true" data-done-button-text="OK" data-none-selected-text="All">
                                    ...
                                    <option <?php if ($row['qualification_level'] == "بروفيسور") {
                                                print ' selected ';
                                            } ?> value="بروفيسور">بروفيسور</option>
                                    <option <?php if ($row['qualification_level'] == "دكتورته") {
                                                print ' selected ';
                                            } ?> value="دكتوراة">دكتوراة</option>
                                    <option <?php if ($row['qualification_level'] == "ماجستير") {
                                                print ' selected ';
                                            } ?> value="ماجستير">ماجستير</option>

                                    <option <?php if ($row['qualification_level'] == "بكالوريوس") {
                                                print ' selected ';
                                            } ?> value="بكالوريوس">بكالوريوس</option>

                                    <option <?php if ($row['qualification_level'] == "شهادة دبلوم") {
                                                print ' selected ';
                                            } ?> value="شهادة دبلوم">شهادة دبلوم</option>

                                    <option <?php if ($row['qualification_level'] == "ثانوية عامه") {
                                                print ' selected ';
                        ...
                        <div class="col-sm-6 col-md-6">
                            ...
                            <div class="form-group">
                                <label>الدولة</label>
                                <select name="country_id" required class="selectpicker show-tick form-control" data-live-search="true">
                                    <option selected value="">Select</option>
                                    <?php
                                    require "../connection.php";
                                    $stmt = mysqli_query($con, "select * from country;");
                                    if (mysqli_num_rows($stmt) > 0) {
                                        while ($cat = mysqli_fetch_assoc($stmt)) { ?>
                                            <option <?php if ($cat['id'] == $row['country_id']) {
                                                        print ' selected ';
                        ...
                        <div class="col-sm-6 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <label>الدرجة</label>
                                <select name="grade" required class="selectpicker show-tick form-control" data-live-search="false">
                                    <option <?php if ($row['grade'] == "جيد جدا") {
                                                print ' selected ';
                                            } ?> value="جيد جدا">جيد جدا</option>
                                    <option <?php if ($row['grade'] == "ممتاز") {
                                                print ' selected ';
                                            } ?> value="ممتاز">ممتاز</option>
                                    <option <?php if ($row['grade'] == "جيد") {
                                                print ' selected ';
                                            } ?> value="جيد">جيد</option>
                                    <option <?php if ($row['grade'] == "مقبول") {
                                                print ' selected ';
                                            } ?> value="مقبول">مقبول</option>
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="على سبيل المثال: 2016 إلى 2020" type="text" name="timeframe" required value="<?php echo $row['timeframe']; ?>">
                            </div>
                    ...
                    <div class="modal-footer text-center">
                        <button type="submit" class="btn btn-primary" name="update_qualification">حفظ</button>
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="sectionn">
            ...
            <div class="content">
                ...
                <!-- title -->
                <div class="title">
                    <h2 class="mb-3">المؤهلات الأكاديمية</h2>
                </div>
                ...
                <div class="container-xxl py-5">
                    <div>
                        ...
                        <?php
                                require "../connection.php";
                                $result2 = mysqli_query($con, "call get_qualification('$id');");
                                            ...
                                            <div class="row g-4">
                                                <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                                    <div class="text-start ps-4">
                                                        ...
                                                        <span class="text-truncate me-3"><i class="fa fa-map-marker-alt text-primary me-2"></i><?php echo $row['country_name']; ?></span>
                                                ...
                                                <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="resume-list-btn">
                                                            ...
                                                            <a href="?q_edit=<?php echo $row['id'] ;?>" class="btn btn-primary btn-sm mb-0-sm">تعديل</a>
                                                            <a onclick="return confirm('هل انت متاكد انك تريد الحذف ؟')" class="btn btn-primary btn-sm mb-0-sm btn-delete">حذف</a>
                        ...
                        <div class="modal" id="QualifModal">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="../server/jobseeker/add_qualification.php" method="POST" autocomplete="off" enctype="multipart/form-data">
                                            <div class="row gap-20 modalbody">
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label>اسم التخصص</label>
                                                        <input class="form-control" placeholder="أدخل اسم التخصص" type="text" name="title" required>
                                                    </div>
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        <label>الإطار الزمني</label>
                                                        <input class="form-control" placeholder="على سبيل المثال: 2016 إلى 2020" type="text" name="timeframe" required>
                                                    </div>
                                            ...
                                            <div class="modal-footer text-center">
                                                ...
                                                <button type="submit" class="btn btn-primary" name="add_qualification">حفظ</button>
                                                <button type="button" data-bs-dismiss="modal" onclick="goBack()" class="btn btn-primary">إلغاء</button>
