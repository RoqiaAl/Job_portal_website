...
<?php
	...
	if(isset($_GET['ex_edit'])){
				
		$no = $_GET['ex_edit'];
					$sql = mysqli_query($con , "call get_by_clause('experience','id','$no');");
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">تعديل خبرة العمل</h4>
          ...
          <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-body">
                ...
                <form action="../server/jobseeker/update_experience.php?no=<?php echo $row['id']; ?>" method="POST" autocomplete="off" enctype="multipart/form-data">
                    <div class="row gap-20 modalbody">
                        ...
                        <div class="col-sm-6 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="أدخل اسم المؤسسة" type="text" name="inistitute" required value="<?php echo $row['inistitute']; ?>" >
                            </div>
                        ...
                        <div class="col-sm-6 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="أدخل رقم هاتف " type="number" name="p_phone" value="<?php echo $row['p_phone']; ?>">
                            </div>
                        ...
                        <div class="col-sm-6 col-md-6">
                            ...
                            <div class="form-group">
                                <label>المسمى الوظيفي </b></label>
                                <input class="form-control" placeholder="أدخل اسم الوظيفة" type="text" name="title" required value="<?php echo $row['title']; ?>">
                            </div>
                        ...
                        <div class="col-sm-6 col-md-6">
                            ...
                            <div class="form-group">
                                <label>تاريخ البدأ </b></label>
                                <input class="form-control" placeholder="Eg: 01 March 2017" type="text" name="start_date" required value="<?php echo $row['start_date']; ?>">
                            </div>
                        ...
                        <div class="col-sm-6 col-md-6">
                            ...
                            <div class="form-group">
                                <label>تاريخ التوقف</label>
                                <input class="form-control" placeholder="Eg: 01 June 2017" type="text" name="end_date" required value="<?php echo $row['end_date']; ?>">
                            </div>
                        ...
                        <div class="col-sm-12 col-md-12">
                            ...
                            <div class="form-group">
                                <label>الواجبات والمسؤوليات</label>
                                <textarea class="form-control" name="responsability" > <?php echo $row['responsability']; ?></textarea>
                            </div>
                    ...
                    <div class="modal-footer text-center">
                        <button type="submit" class="btn btn-primary" name="update_experience" >حفظ</button>
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="sectionn">
            ...
            <div class="content">
                ...
                <!-- title -->
                <div class="title">
                    <h2 class="mb-3">الخبرات العملية</h2>
                </div>
                ...
                <div class="container-xxl py-5">
                    <div>
                        ...
                        <?php
                                require "../connection.php";
                                $result2 = mysqli_query($con, "call get_by_clause('experience','s_id','$id');");
                                        ...
                                        <div class="row g-4">
                                            <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                                <div class="text-start ps-4">
                                                    ...
                                                    <span class="text-truncate me-3"><i class="fa fa-building text-primary me-2"></i><?php echo $row['inistitute']; ?></span>
                                                    <span class="text-truncate me-3"><i class="far fa-calendar-alt text-primary me-2"></i>  <?php echo $row['start_date']; ?> إلى<?php echo $row['end_date']; ?> </span>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="resume-list-btn">
                                                        ...
                                                        <a  href="?ex_edit=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm mb-0-sm">تعديل</a>
                                                        <a onclick="return confirm('هل انت متاكد انك تريد الحذف ؟')" class="btn btn-primary btn-sm mb-0-sm btn-delete" href="../server/jobseeker/delete_experience.php?no=<?php echo $row['id']; ?>" >حذف</a>
                        ...
                        <div>
                            ...
                            <div class="modal" id="QualifModal">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">إضافة خبرات العمل</h4>
                                            <button type="button" class="close" data-bs-dismiss="modal" aria-hidden="true">&times;</button>
                                        </div>
                                        <div class="modal-body">
                                            <b style="color:#990000">جميع الحقول مع * إلزامية</b>
                                            <form action="../server/jobseeker/add_experience.php" method="POST" autocomplete="off" enctype="multipart/form-data">
                                                <div class="row gap-20 modalbody">
                                                    ...
                                                    <div class="col-sm-6 col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label>اسم المؤسسة <b style="color:#990000">*</b></label>
                                                    ...
                                                    <div class="col-sm-6 col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label>رقم هاتف </label>
                                                            <input class="form-control" placeholder="أدخل رقم هاتف " type="number" name="p_phone">
                                                        </div>
                                                    ...
                                                    <div class="col-sm-6 col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label>المسمى الوظيفي <b style="color:#990000">*</b></label>
                                                            <input class="form-control" placeholder="أدخل اسم الوظيفة" type="text" name="title" required>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-6 col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label>تاريخ البدأ <b style="color:#990000">*</b></label>
                                                            <input class="form-control" placeholder="Eg: 01 March 2017" type="text" name="start_date" required>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-6 col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label>تاريخ التوقف <b style="color:#990000">*</b></label>
                                                            <input class="form-control" placeholder="Eg: 01 June 2017" type="text" name="end_date" required>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            <label>الواجبات والمسؤوليات</label>
                                                            <textarea class="form-control" name="responsability"> </textarea>
                                                        </div>
                                                ...
                                                <div class="modal-footer text-center">
                                                    <button type="submit" class="btn btn-primary" name="add_experience" >حفظ</button>
                                                    <button type="button" data-bs-dismiss="modal" onclick="goBack()" class="btn btn-primary">إلغاء</button>
                                                </div>
                                            </form>
