...
<body>
    <?php
    if (isset($_GET['lan_edit'])) {

        $no = $_GET['lan_edit'];
        $sql = mysqli_query($con, "call get_by_clause('language','id','$no');");
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">تعديل اللغة</h4>
                        <button type="button" class="close" onclick="goBack()" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="../server/jobseeker/update_language.php?no=<?php echo $row['id'] ?>" method="POST" autocomplete="off" enctype="multipart/form-data">
                            <div class="row gap-20 modalbody">
                                <div class="col-sm-12 col-md-12">

                                    <div class="form-group">
                                        <label>اللغة</label>
                                        <input class="form-control" value="<?php echo $row['name'] ?>" placeholder="أدخل اسم اللغة" type="text" name="name" required>
                                    </div>
                                ...
                                <div class="col-sm-12 col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label>النطق</label>
                                        <select name="speaking" required class="selectpicker show-tick form-control" data-live-search="false">
                                            <option <?php if ($row['speaking'] == "جيد جدا") {
                                                        print ' selected ';
                                                    } ?> value="جيد جدا">جيد جدا</option>
                                            <option <?php if ($row['speaking'] == "ممتاز") {
                                                        print ' selected ';
                                                    } ?> value="ممتاز">ممتاز</option>
                                            <option <?php if ($row['speaking'] == "جيد") {
                                                        print ' selected ';
                                ...
                                <div class="col-sm-12 col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label>القراءة</label>
                                        <select name="reading" required class="selectpicker show-tick form-control" data-live-search="false">
                                            <option <?php if ($row['reading'] == "جيد جدا") {
                                                        print ' selected ';
                                                    } ?> value="جيد جدا">جيد جدا</option>
                                            <option <?php if ($row['reading'] == "ممتاز") {
                                                        print ' selected ';
                                                    } ?> value="ممتاز">ممتاز</option>
                                            <option <?php if ($row['reading'] == "جيد") {
                                                        print ' selected ';
                                                    } ?> value="جيد">جيد</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-sm-12 col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label>الكتابة</label>
                                        <select name="writing" required class="selectpicker show-tick form-control" data-live-search="false">
                                            <option <?php if ($row['writing'] == "جيد جدا") {
                                                        print ' selected ';
                                                    } ?> value="جيد جدا">جيد جدا</option>
                                            <option <?php if ($row['writing'] == "ممتاز") {
                                                        print ' selected ';
                                                    } ?> value="ممتاز">ممتاز</option>
                                            <option <?php if ($row['writing'] == "جيد") {
                                                        print ' selected ';
                                                    } ?> value="جيد">جيد</option>
                                        </select>
                                    </div>
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-primary" name="update_language">حفظ</button>
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="sectionn">
            ...
            <div class="content">
                ...
                <!-- title -->
                <div class="title">
                    <h2 class="mb-3">اللغات التي تجيدها</h2>
                </div>
                ...
                <div class="container-xxl py-5">
                    <div>
                        <div class="row g-4 text-start">
                            <?php
                            require "../connection.php";
                            $result2 = mysqli_query($con, "call get_by_clause('language','s_id','$id');");
                                            ...
                                            <div class="row g-4">
                                                <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                                    <div class="text-start ps-4">
                                                        ...
                                                        <span class="text-truncate me-3"><i class="fa fa-user text-primary me-2"></i>نطقاً -<?php echo $row['speaking']; ?></span>
                                                        <span class="text-truncate me-3"><i class="fa fa-book text-primary me-2"></i>قراءة -<?php echo $row['reading']; ?></span>
                                                        <span class="text-truncate me-3"><i class="bx bxs-pencil text-primary me-2"></i>كتابة -<?php echo $row['writing']; ?></span>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="resume-list-btn">
                                                            ...
                                                            <a href="?lan_edit=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm mb-0-sm">تعديل</a>
                                                            <a onclick="return confirm('هل انت متاكد انك تريد الحذف ؟')" class="btn btn-primary btn-sm mb-0-sm btn-delete" href="../server/jobseeker/delete_language.php?no=<?php echo $row['id']; ?>">حذف</a>
                            ...
                            <div class="modal" id="QualifModal">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="../server/jobseeker/add_language.php" method="POST" autocomplete="off" enctype="multipart/form-data">
                                                <div class="row gap-20 modalbody">
                                                    <div class="col-sm-12 col-md-12">

                                                        <div class="form-group">
                                                            <label>اللغة</label>
                                                            <input class="form-control" value="" placeholder="أدخل اسم اللغة" type="text" name="name" required>
                                                        </div>
                                                ...
                                                <div class="modal-footer text-center">
                                                    <button type="submit" class="btn btn-primary" name="add_language">حفظ</button>
                                                    <button type="button" data-bs-dismiss="modal" onclick="goBack()" class="btn btn-primary">إلغاء</button>
                                                </div>
                                            </form>
