    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../server/jobseeker/update_feedback.php?no=<?php echo $row['id']; ?>" method="POST" autocomplete="off" enctype="multipart/form-data">
                    <div class="row gap-20 modalbody">
                        ...
                        <div class="col-sm-6 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" placeholder="اكتب تعليقك هنا" required name="body" ><?php echo $row['body']; ?> </textarea>
                            </div>
                                            ...
                                            <div class="col-sm-12 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                                <div class="d-flex">
                                                    ...
                                                    <a href="?fb_edit=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm mb-0-sm">تعديل</a>
                                                            <a onclick="return confirm('هل انت متاكد انك تريد الحذف ؟')" class="btn btn-primary btn-sm mb-0-sm btn-delete" href="../server/jobseeker/delete_feedback.php?no=<?php echo $row['id']; ?>">حذف</a>
                            ...
                            <div class="modal" id="QualifModal">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="../server/jobseeker/add_feedback.php" method="POST" autocomplete="off" enctype="multipart/form-data">
                                                <div class="row gap-20 modalbody">
