...
<link rel="stylesheet" href="../dashboard/css/custom.css">
    ...
    <div class="container-fluid ">
        <?php 
        $query = mysqli_query($con, "call company_details('$no')");
        ...
        while ($row = mysqli_fetch_assoc($query)) {
            ...
            <div class="job-item detail p-4 mb-4">
                <div class="row g-4">
                    <div class="col-sm-12 col-md-8 d-flex align-items-center">
                        <img class="flex-shrink-0 img-fluid border rounded" src="<?php echo 'data:image/png;base64 ,' . base64_encode($row['co_logo']) ?> "
                            style="width: 80px; height: 80px;">
                        <div class="text-start ps-4">

                            <h5 class="mb-3"><?php echo $row['co_name']; ?></h5>

                            <span class="text-truncate me-3"><i class="fa fa-city text-primary me-2"></i><?php echo $row['region_name']; ?></span>
                            <span class="text-truncate me-3"><i class="far fa-clock text-primary me-2"></i>working
                                time : <?php echo $row['working_time']; ?></span>
                            <span class="text-truncate me-0"><i
                                    class="far fa fa-map-marker-alt text-primary me-2"></i><?php echo $row['address']; ?></span>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <span class="text-truncate me-0"><i
                                    class="far  fa-global text-primary me-2"></i>website:<a href="">
                                    <?php echo $row['website']; ?></a></span>
                        </div>
                        <small class="text-truncate"><i class="far fa-calendar-alt text-primary me-2"></i>created at
            ...
            <div class="job-item p-4 mb-4"  >
                <div class="row g-4 ">
                    <div class="text-start ps-4"   >
                        <h5 class="mb-3 " style="color: rgba(11, 92, 255, 1); text-align: right;"> : خلفية عن الشركة</h5>
                        <p style="text-align: right;"><?php echo $row['co_background']; ?>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="job-item p-4 mb-4">
                <div class="row g-4 ">
                    <div class="text-start ps-4">
                        <h5 class="mb-3" style="color: rgba(11, 92, 255, 1); text-align: right;">: اهداف الشركة
                        </h5>
                        <p style="text-align: right;"><?php echo $row['goal']; ?>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="job-item p-4 mb-4">
                <div class="row g-4 ">
                    <div class="text-start ps-4">
                        <h5 class="mb-3"  style="color: rgba(11, 92, 255, 1); text-align: right;">: رؤية الشركة
                        </h5>
                        <p style="text-align: right;"><?php echo $row['vision']; ?>
                        </p>
                    </div>
                </div>
            </div>
