    ...
    ?>
                            ...
                            <div class="row g-2 " style="margin-top: 1px; margin-bottom: 22px;">
                                    ...
                                    <select class="form-select border-0" name="region_id">
                                        ...
                                        if (mysqli_num_rows($stmt) > 0) {
                                            while ($cat = mysqli_fetch_assoc($stmt)) { ?>
                                                <option <?php if ($cat['id'] == $region_id) {
                                                            print ' selected ';
                                ...
                                <div class="col-md-4">
                                    <select class="form-select border-0" name="category_id">
                                        ...
                                        if (mysqli_num_rows($stmt) > 0) {
                                            while ($cat = mysqli_fetch_assoc($stmt)) { ?>
                                                <option <?php if ($cat['id'] == $category_id) {
                                                            print ' selected ';
                                                        } ?> value="<?php echo $cat['id']; ?>"><?php echo $cat['name']; ?></option>
                                ...
                                <div class="col-md-4">
                                    <select name="working_time" class="form-select border-0">
                                        ...
                                        <option <?php if ($working_time == "full_time") {
                                                    print ' selected ';
                                                } ?> value="full_time"> دوام كامل</option>
                                        <option <?php if ($working_time == "part_time") {
                                                    print ' selected ';
                                                } ?> value="part_time">نصف دوام</option>
                                        <option <?php if ($working_time == "online") {
                                                    print ' selected ';
        ...
        <div class="container-xxl py-5">
            <div class="container">
                ...
                $query = mysqli_query($con, "call search_jobs('$region_id','$category_id','$working_time');");
                ...
                <?php } 
                    ...
                    <div class="row g-4">
                       <h1 style="text-align:right;"> ! لايوجد وظائف تطابق نتيجة البحث حاليا </h1>
